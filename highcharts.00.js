...
Tooltip.prototype = {
    ...
    refresh: function (point, mouseEvent) {
        ...
        if (shared && !(point.seriesList && point.seriesList.noSharedTooltip)) {
            // hide previous hoverPoints and set new
...
Chart.prototype = {
    ...
    getMargins: function () {
        ...
        if ((chart.title) && !defined(chart.optionsMarginTop)) {
            titleOffset = mathMax(
    ...
    propFromSeries: function () {
        var chart = this,
            optionsChart = chart.options.chart,
            klass,
            seriesOptions = chart.options.seriesList,
            i,
            value;
    ...
    destroy: function () {
        ...
        each(['title', 'chartBackground', 'plotBackground', 'plotBGImage',
...
Point.prototype = {
    ...
    onMouseOut: function () {
        var chart = this.seriesList.chart,
            hoverPoints = chart.hoverPoints;
