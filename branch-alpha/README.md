...
# Status
| Branch | [master<br>(v2024.5.26)](https://github.com/kaizhu256/sqlmath/tree/master) | [beta<br>(Web Demo)](https://github.com/kaizhu256/sqlmath/tree/beta) | [alpha<br>(Development)](https://github.com/kaizhu256/sqlmath/tree/alpha) |
|--:|:--:|:--:|:--:|
...
```shell
    ...
    shUpgrade() {
        ...
        FILE="$3"
        git grep "$AA" || true
        read -p "Press Enter to sed:"
        for FILE in $FILE
        do
            sed -i -e "s|\<$AA\>|$BB|g" "$FILE"
        done
        git grep "$AA" || true
    }
    #
    # lgbm
    shUpgrade "v4\.3\.0" "v4\.4\.0" ".ci.sh sqlmath_base.h"
    #
    # sqlite
    shUpgrade "3\.42\.0" "3\.44\.2" ".ci.sh sqlmath_external_sqlite.c"
    shUpgrade "3420000" "3440200" ".ci.sh sqlmath_external_sqlite.c"
    #
    # lgbm
    shUpgrade "1\.3\.0" "1\.3\.1" ".ci.sh sqlmath_external_zlib.c"
    #
    # shSqlmathUpdate
