...
python -m build
#
twine upload --repository testpypi dist/sqlmath-2025.11.1*
py -m pip install --index-url https://test.pypi.org/simple/ sqlmath==2025.11.1
#
twine upload dist/sqlmath-2025.11.1*
pip install sqlmath==2025.11.1
```
